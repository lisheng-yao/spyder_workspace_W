...
"}")
        ...
        self.pushButton.clicked.connect(self.handle_upload_button_click) # type: ignore
        QtCore.QMetaObject.connectSlotsByName(Dialog)
        
    def handle_upload_button_click(self):
        # 在這裡處理按鈕點擊事件的相應動作
        options = QtWidgets.QFileDialog.Options()
        file_path, _ = QtWidgets.QFileDialog.getOpenFileName(Dialog, "選擇 CSV 文件", "", "CSV Files (*.csv);;All Files (*)", options=options)
