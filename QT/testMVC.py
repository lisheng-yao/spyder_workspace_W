...
"}")
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 60, 371, 271))
        ...
        self.graphicsView.setGeometry(QtCore.QRect(600, 10, 411, 101))
        self.graphicsView.setObjectName("graphicsView")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(470, 130, 541, 561))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setToolTip(_translate("MainWindow", "<html><head/><body><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">描述：指定要將數據分割成的簇的數量。</li><li style=\" margin-top:0px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">推薦：使用者可能需要根據數據的性質和業務需求選擇適當的簇數量。可以嘗試不同的簇數量，然後使用一些評估指標（如輪廓系數、肘部法則等）來選擇最佳的簇數量。</li></ul></body></html>"))
        ...
        self.spinBox_n_clusters.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">簇的數量 (n_clusters):</span></p><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">描述：指定要將數據分割成的簇的數量。</li><li style=\" margin-top:0px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">推薦：使用者可能需要根據數據的性質和業務需求選擇適當的簇數量。可以嘗試不同的簇數量，然後使用一些評估指標（如輪廓系數、肘部法則等）來選擇最佳的簇數量。</li></ul></body></html>"))
        ...
        self.spinBox.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">隨機數種子 (random_state):</span></p><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">描述：指定隨機數生成器的種子，以確保每次運行都得到相同的結果。</li><li style=\" margin-top:0px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">推薦：在調試和複現實驗結果時使用，可以使結果更可控。</li></ul></body></html>"))
